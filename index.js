...
const SUB_PATH = process.env.SUB_PATH || 'hello-word';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 20000;        // http服务订阅端口
const UUID = process.env.UUID || '9a127049-c50b-470b-a1db-fcd073e71787'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'modvc.gl.edu.eu.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZDBlYWQ3NWY5MWNmMDJiNTM2MjAwNTZiMzc3ZWMwNmQiLCJ0IjoiMWMxZTAwZTAtYmRmZC00ZmQ1LTlmNzUtMjMwMDhhNDUxNThiIiwicyI6Ik16aGpOR0V5WVRjdE1URmxaaTAwWkdVNExXSXhOamd0TkRKa00yRTROREJqWkRoaCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8081;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'www.visa.cn';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'modvc';                        // 节点名称
